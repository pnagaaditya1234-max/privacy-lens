      ...
      <div className="container px-4 md:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-xl font-bold">PrivacyLens</span>
            </div>
            <p className="text-background/70 mb-6 max-w-sm">
              AI-powered PII detection and masking platform. Protect sensitive data, ensure compliance, and prevent data leaks.
            </p>
        ...
        <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-background/60 text-sm">
            © {currentYear} PrivacyLens. All rights reserved.
          </p>
          <p className="text-background/60 text-sm">
